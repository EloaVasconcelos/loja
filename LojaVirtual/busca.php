...
<body>	
	...
	$consulta = $cn->query("select * from vw_MoletomOFC10 where Nome like concat ('%', '$pesquisa', '%') or Cor like concat  ('%', '$pesquisa', '%')");
...
<?php while  ($exibe = $consulta->fetch(PDO::FETCH_ASSOC)) { ?>
	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-sm-2"><h4 style="padding-top:20px">R$<?php echo number_format($exibe['Valor'], 2, ',', '.'); ?></h4></div>
